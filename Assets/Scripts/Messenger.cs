...
#pragma warning disable 0414
	...
	static private PreserveMessenger preserveMessenger = (new GameObject("PreserveMessenger")).AddComponent<PreserveMessenger>();
...
public sealed class PreserveMessenger : MonoBehaviour
{
	void Awake()
	{
